...
nnoremap <silent><C-p> :lua require('robert.plugin.telescope').project_files()<CR>
...
nnoremap <silent><leader>vc :lua require('robert.plugin.telescope').search_dotfiles()<CR>
